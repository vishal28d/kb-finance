...
import 'package:credit_app/views/Commercial%20Vehicle%20Loan/commercial_refinance.dart';
import 'package:credit_app/views/Commercial%20Vehicle%20Loan/commercial_vehicle_document.dart';
import 'package:credit_app/views/Commercial%20Vehicle%20Loan/tractorPurchaseForm.dart';
import 'package:credit_app/views/Commercial%20Vehicle%20Loan/tractor_refinance.dart';
...
class ComVehicleLoanScreen extends StatefulWidget {
  @override
  _ComVehicleLoanState createState() => _ComVehicleLoanState();
}

class _ComVehicleLoanState extends State<ComVehicleLoanScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Commercial Vehicle Loan'),
        centerTitle: true,
      ),
      body: PageView(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Enter House Area (Square Feet)', style: Theme.of(context).textTheme.bodyLarge),
          CustomTextFormField(
...
Widget _buildWorkDetailsStep(BuildContext context) {
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        Text('Select Current Loan Type', style: Theme.of(context).textTheme.bodyLarge),
        CustomDropDown(
          hint: Text("Select Loan Type"),
          list: [
  "Loan Takeover / BT",
  ...
  "Investment"
      ...
      // commercial vehicle loan details
        Text('Commercial Vehicle Loan Details', style: Theme.of(context).textTheme.titleLarge),
        SizedBox(height: 10,) ,
         Obx(() => Column(
  children: [
    
    // Conditionally show forms based on the selected loan type
    if (loanController.selectedLoanType.value == "Tractor Purchase") 
      TractorPurchaseFormPage(),

    if (loanController.selectedLoanType.value == "Commercial Refinance") 
      CommercialRefinanceFormPage(),

    if (loanController.selectedLoanType.value == "Commercial Purchase") 
      CommercialPurchaseLoanForm(),

    if (loanController.selectedLoanType.value == "Tractor Refinance") 
      TractorRefinanceForm(),
    ],
  )),
        ...
        children: [
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ComVehicleDocController comVehicleDocController = ComVehicleDocController() ;
              comVehicleDocController.update() ;
              setState(() {
