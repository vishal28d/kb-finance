...
class CommercialMortgageLoanForm extends StatelessWidget {
  final loanController = PropertyLoanController();
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Text('I Want Mortgage for', style: Theme.of(context).textTheme.bodyLarge),
          CustomDropDown(
            hint: Text("Select Mortgage Type"),
            list: ["Open Land", "Factory", "Godown", "Hospital", "School", "Other", "Industrial", "Agriculture"],
