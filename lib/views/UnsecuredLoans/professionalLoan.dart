...
class _ProfessionalLoanFormState extends State<ProfessionalLoanForm> {
  final ProfessionalLoanController loanController =
      Get.put(ProfessionalLoanController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Unsecured Loan Form'),
        centerTitle: true,
      ),
      body: PageView(
        ...
        children: [
          ...
          CustomDropDown(
            ...
            val: loanController.selectedReligion.value.isNotEmpty
                ...
                : null,
            onChanged: (value) =>
                loanController.selectedReligion.value = value.toString(),
          ),
          SizedBox(height: 10),
          ...
          CustomDropDown(
            ...
            val: loanController.selectedCaste.value.isNotEmpty
                ? loanController.selectedCaste.value
                : null,
            onChanged: (value) =>
                loanController.selectedCaste.value = value.toString(),
          ),
          SizedBox(height: 10),
          ...
          CustomDropDown(
            ...
            list: ['Single', 'Married'],
            val: loanController.maritalStatus.value.isNotEmpty
                ? loanController.maritalStatus.value
                : null,
            onChanged: (value) =>
                loanController.maritalStatus.value = value.toString(),
          ),
          SizedBox(height: 10),
          Obx(() {
            if (loanController.maritalStatus.value == 'Married') {
              return Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text('Spouse\'s Mobile Number',
                      style: Theme.of(context).textTheme.bodyLarge),
                  CustomTextFormField(
                    hintText: "Enter Spouse's mobile number",
                    textEditingController:
                        loanController.spouseMobileController,
                    textInputType: TextInputType.phone,
                  ),
                  SizedBox(height: 10),
                  Obx(() {
                    ...
                    if (loanController.spouseDob.value.isNotEmpty) {
                      selectedDate = DateFormat('dd-MM-yyyy')
                          .parse(loanController.spouseDob.value);
                    }
                    return DatePickerField(
                      ...
                      onChanged: (DateTime? date) {
                        if (date != null) {
                          ...
                          loanController.spouseDob.value =
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    if (loanController.nomineeDob.value.isNotEmpty) {
                      selectedDate = DateFormat('dd-MM-yyyy')
                          .parse(loanController.nomineeDob.value);
                    }
                    ...
                    return DatePickerField(
                      ...
                      onChanged: (DateTime? date) {
                        if (date != null) {
                          ...
                          loanController.nomineeDob.value =
                              DateFormat('dd-MM-yyyy').format(date);
                        }
                      },
                    );
                  ...
                  SizedBox(height: 10),
                  Text('Nominee\'s Relation',
                      style: Theme.of(context).textTheme.bodyLarge),
                  CustomTextFormField(
                    hintText: "Enter nominee's relation",
                    textEditingController:
                        loanController.nomineeRelationController,
                  ),
                  SizedBox(height: 10),
                ],
              );
        ...
        children: [
          ...
          CustomDropDown(
            ...
            val: loanController.selectedJobType.value.isNotEmpty
                ...
                : null,
            onChanged: (value) =>
                loanController.selectedJobType.value = value.toString(),
          ),
      ...
      // current loan details
        ...
        Divider(),
          ...
          Text('Additional Details',
              style: Theme.of(context).textTheme.titleLarge),
          SizedBox(height: 10),
          Text('Do You Have Car Or Commercial Vehicle ? If You Have',
              style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: Colors.black54)),
          Text('Enter Car Name With Company Name',
              style: Theme.of(context).textTheme.bodyLarge),
          CustomTextFormField(
          ...
          Text('Are you using Credit Card (if yes)',
              style: Theme.of(context).textTheme.bodyLarge),
          CustomTextFormField(
          ...
          Obx(() {
            if ((loanController.selectedJobType.value == 'Business' ||
                        loanController.selectedJobType.value ==
                            'Professional') &&
                    loanController.selectedLoanType.value == 'Business Loan' ||
                loanController.selectedLoanType.value == 'Professional Loan') {
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                  ...
                  CustomDropDown(
                    ...
                    val: loanController.isAudited.value.isNotEmpty
                        ...
                        : null,
                    onChanged: (value) =>
                        loanController.isAudited.value = value.toString(),
                  ),
                ],
              );
            } else {
  ...
  Widget _buildProfessionalDetails() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        Text('Workplace Name(e.g. hospital/clinic/firm)',
            style: Theme.of(context).textTheme.bodyLarge),
        CustomTextFormField(
      ...
      children: [
        ...
        CustomDropDown(
          ...
          val: loanController.businessType.value.isNotEmpty
              ...
              : null,
          onChanged: (value) =>
              loanController.businessType.value = value.toString(),
        ),
        SizedBox(height: 10),
        ...
        SizedBox(height: 10),
        Text('Business Registration Date',
            style: Theme.of(context).textTheme.bodyLarge),
        CustomTextFormField(
          hintText: "Enter registration date",
        ...
        SizedBox(height: 10),
        Text('Number of Years in this business',
            style: Theme.of(context).textTheme.bodyLarge),
        CustomTextFormField(
      ...
      child: Row(
        ...
        children: [
          ElevatedButton(
            style: ButtonStyle(
                backgroundColor:
                    WidgetStateProperty.all(Color.fromARGB(255, 167, 12, 12))),
            onPressed: () {
            ...
            onPressed: () {
              if (_currentPage == 3) {
                ...
                showConfirmationDialog(context, () {
                  ...
                  ProfessionalDocController professionalDocController =
                      ProfessionalDocController();
                  professionalDocController.clearSelectedDocuments();

                  Future.delayed(Duration(seconds: 3), () {
                    if (loanController.validateForm()) {
