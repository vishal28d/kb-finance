      ...
      return SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Obx(() {
              if (loanController.isAuditSelected.value) {
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildUploadCard(context, 'Last 2 Years Audit Report', 'audit_report'),
                    SizedBox(height: 10),
                    _buildUploadCard(context, 'Last 12 Month GST', 'gst'),
                  ],
                );
              } else {
                return Container();
              ...
              shape: WidgetStateProperty.all(
                ...
                onPressed: () async {
                  ...
                  if (loanController.isError.value) {
                    ...
                    Get.snackbar('Upload Failed', 'Some documents failed to upload. Please try again.' , backgroundColor: Colors.green[400] ,duration: Duration(seconds: 5) );
                  } else {
...
class ProfessionalDocController extends GetxController {
  ...
  Future<String> uploadDocumentToFirebase(String docType, String filePath) async {
    ...
    try {
      ...
      Reference storageRef = FirebaseStorage.instance.ref().child('documents/$docType/$fileName');
