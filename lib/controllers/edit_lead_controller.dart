...
List<String> getLeadDetails() {
 ...
 final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  ...
  Future<void> updateLeadInFirestore(String docId) async {
  ...
  try {
    ...
    // Update the existing lead in Firestore using the document ID
    await _firestore.collection('leadDetails').doc(docId).update(leadData);
